...
public interface TmPiecesRefIntf extends BaseMybatisMapper {
	...
	@Select("SELECT  TM_PIECES_REF_ID  AS tmPiecesRefId, TM_PIECES_ID  AS tmPiecesId, PIECES_NO  AS piecesNo, REF_TYPE  AS refType, REF_ID  AS refId, REF_CODE  AS refCode, SUMMARY  AS summary, COMPANY_CODE  AS companyCode, RECORD_VERSION  AS recordVersion, CREATE_USER_CODE  AS createUserCode, CREATE_DATE_TIME  AS createDateTime, CREATE_TIME_ZONE  AS createTimeZone, UPDATE_USER_CODE  AS updateUserCode, UPDATE_DATE_TIME  AS updateDateTime, UPDATE_TIME_ZONE  AS updateTimeZone FROM tm_pieces_ref WHERE tm_pieces_ref_id=#{tmPiecesRefId}")
	...
	@Insert("insert into tm_pieces_ref ( TM_PIECES_REF_ID, TM_PIECES_ID, PIECES_NO, REF_TYPE, REF_ID, REF_CODE, SUMMARY, COMPANY_CODE, RECORD_VERSION, CREATE_USER_CODE, CREATE_DATE_TIME, CREATE_TIME_ZONE, UPDATE_USER_CODE, UPDATE_DATE_TIME, UPDATE_TIME_ZONE ) values (#{tmPiecesRefId},#{tmPiecesId},#{piecesNo},#{refType},#{refId},#{refCode},#{summary},#{companyCode},#{recordVersion},#{createUserCode},#{createDateTime},#{createTimeZone},#{updateUserCode},#{updateDateTime},#{updateTimeZone})")
