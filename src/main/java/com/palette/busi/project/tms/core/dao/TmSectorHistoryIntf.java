...
public interface TmSectorHistoryIntf extends BaseMybatisMapper {
	...
	@Select("SELECT  TM_SECTOR_HISTORY_ID  AS tmSectorHistoryId, TM_SECTOR_ID  AS tmSectorId, SECTOR_CODE  AS sectorCode, ACTION_CODE  AS actionCode, MEMO  AS memo, ACTION_PLACE  AS actionPlace, ACTION_DATE_TIME  AS actionDateTime, ACTION_USER_NAME  AS actionUserName, COMPANY_CODE  AS companyCode, RECORD_VERSION  AS recordVersion, CREATE_USER_CODE  AS createUserCode, CREATE_DATE_TIME  AS createDateTime, UPDATE_USER_CODE  AS updateUserCode, UPDATE_DATE_TIME  AS updateDateTime FROM tm_sector_history WHERE tm_sector_history_id=#{tmSectorHistoryId}")
	public TmSectorHistory selectTmSectorHistoryById(@Param("tmSectorHistoryId") int tmSectorHistoryId);
	
	@Select("SELECT  TM_SECTOR_HISTORY_ID  AS tmSectorHistoryId, TM_SECTOR_ID  AS tmSectorId, SECTOR_CODE  AS sectorCode, ACTION_CODE  AS actionCode, MEMO  AS memo, ACTION_PLACE  AS actionPlace, ACTION_DATE_TIME  AS actionDateTime, ACTION_USER_NAME  AS actionUserName, COMPANY_CODE  AS companyCode, RECORD_VERSION  AS recordVersion, CREATE_USER_CODE  AS createUserCode, CREATE_DATE_TIME  AS createDateTime, UPDATE_USER_CODE  AS updateUserCode, UPDATE_DATE_TIME  AS updateDateTime FROM tm_sector_history")
