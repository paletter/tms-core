...
public class WmLocationCurrent extends BasePo {

	private static final long serialVersionUID = 1L;
	
    private Integer wmLocationCurrentId;
    ...
    public Integer getWmLocationCurrentId() {
        return wmLocationCurrentId;
    }
        
    public void setWmLocationCurrentId(Integer wmLocationCurrentId) {
        this.wmLocationCurrentId = wmLocationCurrentId;
    }
