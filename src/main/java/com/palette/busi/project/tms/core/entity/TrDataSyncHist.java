...
public class TrDataSyncHist extends BasePo {

	private static final long serialVersionUID = 1L;
	
    private Integer trDataSyncHistId;
    ...
    public Integer getTrDataSyncHistId() {
        return trDataSyncHistId;
    }
        
    public void setTrDataSyncHistId(Integer trDataSyncHistId) {
        this.trDataSyncHistId = trDataSyncHistId;
    }
