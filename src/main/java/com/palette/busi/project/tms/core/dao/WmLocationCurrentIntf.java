...
public interface WmLocationCurrentIntf extends BaseMybatisMapper {
	...
	@Select("SELECT  WM_LOCATION_CURRENT_ID  AS wmLocationCurrentId, WM_LOCATION_ID  AS wmLocationId, LOCATION_CODE  AS locationCode, WAREHOUSE_CODE  AS warehouseCode, TM_PIECES_ID  AS tmPiecesId, PIECES_NO  AS piecesNo, TM_CONSIGNMENT_ID  AS tmConsignmentId, CONSIGNMENT_NO  AS consignmentNo, MEMO  AS memo, COMPANY_CODE  AS companyCode, RECORD_VERSION  AS recordVersion, CREATE_USER_CODE  AS createUserCode, CREATE_DATE_TIME  AS createDateTime, CREATE_TIME_ZONE  AS createTimeZone, UPDATE_USER_CODE  AS updateUserCode, UPDATE_DATE_TIME  AS updateDateTime, UPDATE_TIME_ZONE  AS updateTimeZone FROM wm_location_current WHERE wm_location_current_id=#{wmLocationCurrentId}")
	...
	@Insert("insert into wm_location_current ( WM_LOCATION_CURRENT_ID, WM_LOCATION_ID, LOCATION_CODE, WAREHOUSE_CODE, TM_PIECES_ID, PIECES_NO, TM_CONSIGNMENT_ID, CONSIGNMENT_NO, MEMO, COMPANY_CODE, RECORD_VERSION, CREATE_USER_CODE, CREATE_DATE_TIME, CREATE_TIME_ZONE, UPDATE_USER_CODE, UPDATE_DATE_TIME, UPDATE_TIME_ZONE ) values (#{wmLocationCurrentId},#{wmLocationId},#{locationCode},#{warehouseCode},#{tmPiecesId},#{piecesNo},#{tmConsignmentId},#{consignmentNo},#{memo},#{companyCode},#{recordVersion},#{createUserCode},#{createDateTime},#{createTimeZone},#{updateUserCode},#{updateDateTime},#{updateTimeZone})")
