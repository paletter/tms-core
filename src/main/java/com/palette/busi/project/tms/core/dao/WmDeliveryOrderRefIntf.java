...
public interface WmDeliveryOrderRefIntf extends BaseMybatisMapper {
	...
	@Insert("insert into wm_delivery_order_ref ( WM_DELIVERY_ORDER_REF_ID, WM_DELIVERY_ORDER_ID, DELIVERY_ORDER_NO, REF_TYPE, REF_ID, REF_CODE, RECORD_VERSION, CREATE_DATE_TIME, CREATE_USER_CODE, UPDATE_DATE_TIME, UPDATE_USER_CODE ) values (#{wmDeliveryOrderRefId},#{wmDeliveryOrderId},#{deliveryOrderNo},#{refType},#{refId},#{refCode},#{recordVersion},#{createDateTime},#{createUserCode},#{updateDateTime},#{updateUserCode})")
